...
class BacklogControllerIT extends AbstractIntegrationTest {
    ...
    @Test
    void getReturnsIssuesWithNoSprintOrderedByBacklogRank() throws Exception {
        ...
        assertThat(issues[0].key()).isEqualTo(issue.key());
    }
    ...
    void getByNonMemberReturns403() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/projects/{projectKey}/backlog", key)
                        .header(HttpHeaders.AUTHORIZATION, "Bearer " + outsiderToken))
                .andExpect(status().isForbidden());
    }

    @Test
    void getForUnknownProjectReturns404() throws Exception {
    ...
    @Test
    void getIsVisibleToPlainMember() throws Exception {
        String ownerEmail = uniqueEmail();
